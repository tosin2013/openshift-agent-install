...
**See**: [docs/openshift-forwarder-role.md](openshift-forwarder-role) for details on using the role directly.
...
- **openshift-forwarder Role**: [docs/openshift-forwarder-role.md](openshift-forwarder-role)
