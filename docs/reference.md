...
Reference material is **information-oriented**. These pages describe the machinery of the tooling accurately and completely. They are not instructional — they are looked up when you need a specific fact, parameter value, or compatibility constraint.

Use reference pages when you already know what you are looking for and need precise information.
